...
function App() {
  ...
  const [myData, setMyData] = useState([
    {no:1, contents:'오늘은 React공부하는날', writer:'낙짜쌤', date:'2023-01-01'},
    {no:2, contents:'어제는 Javascript공부해씸', writer:'유겸이', date:'2023-03-03'},
    {no:3, contents:'내일은 Project해야징', writer:'개똥이', date:'2023-05-05'},
  ]);
